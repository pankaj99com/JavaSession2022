...
public class MethodOverloading {
	...
	public static void main() {
		System.out.println("pankajlllllllll");

	}

	public static void main(int a, int b) {
		System.out.println("JVM reponsibility to call the main method and that reason it will ignore overloaded main methods");
	}
	...
	public void sum(int a, String z) {
		System.out.println("Integer+String  input parameters");
	}
